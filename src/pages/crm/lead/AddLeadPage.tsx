...
import { Sparkles, AlertCircle, Info, Loader2, Save, X } from 'lucide-react';
    ...
    onSuccess: async (record) => {
      ...
      if (panelRef.current?.hasStagedFiles()) {
        ...
        try {
          ...
          setUploadError('Lead saved, but file upload failed. Re-upload from the record page.');
        } finally {
      ...
      >
        ...
        <div className="shrink-0 flex items-start gap-3 border-b border-amber-200 bg-amber-50 px-5 py-2.5">
          ...
          <p className="text-xs text-amber-800">
            <span className="font-bold">Status scope:</span>{' '}
            New leads can be Qualified or UnQualified. Edit a lead to advance it to Prospect or Customer.
          </p>
        </div>
