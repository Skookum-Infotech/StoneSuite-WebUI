              ...
              {entry.type === "transition" && (
                <>
                  ...
                  <div className="flex items-center gap-1 mt-1.5">
                    ...
                    <span className="text-2xs bg-emerald-50 text-emerald-600 px-1.5 py-0.5 rounded-md font-medium">
                      {entry.toState}
                    </span>
                  </div>
                </>
...
export default function CustomerDetailPage() {
  ...
  if (error || !record)
    return (
      <div className="p-6">
        <ErrorNote>{apiErrorMessage(error, "Failed to load customer.")}</ErrorNote>
      </div>
    );
