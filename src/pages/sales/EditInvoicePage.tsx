...
interface InvoiceEditDraft {
  activeTab: PageTab;
  localData: Record<string, unknown> | null;
  localLineItems: InvoiceLineItem[] | null;
...
export default function EditInvoicePage() {
  ...
  const inventoryReturn = useInventoryItemReturn<InvoiceEditDraft>();
  ...
  const [localLineItems, setLocalLineItems] = useState<InvoiceLineItem[] | null>(restored?.localLineItems ?? null);
