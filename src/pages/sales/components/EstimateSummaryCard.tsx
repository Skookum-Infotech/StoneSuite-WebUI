...
// Mirrors InvoiceSummaryCard, minus amountPaid/balanceDue — an estimate has
// no payment tracking (that only exists on Invoice).
export function EstimateSummaryCard({ subtotal, discountAmt, taxTotal, total }: {
