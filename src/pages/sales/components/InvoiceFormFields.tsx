...
export function InvoiceField({ field, value, set, lookups, dependsOnValue, disabled }: {
  ...
  if (field.type === 'select') {
    // lookupKey fields (country/state/payment terms/price level/currency/
    // employee) source their options from CrmLookups by numeric id, so the
    // stored value is the id (string) — matching the create payload's *Id
    // fields — rather than a display label.
