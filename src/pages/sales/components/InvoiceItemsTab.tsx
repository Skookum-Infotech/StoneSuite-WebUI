...
// Unlike Sales Order, an invoice line has no free-text sku/units/tax% input —
// sku/units are display-only (populated when a catalog item is picked) and
// tax% always mirrors the header's Sales Tax % (invoiceForm.ts's
...
// (see InvoiceLineItem doc in invoiceForm.ts).
export function InvoiceItemsTab({ items, onUpdate, headerTaxPercent }: {
