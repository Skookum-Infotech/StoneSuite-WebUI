...
export default function CreateRolePage() {
  ...
  function saveDraft() {
    localStorage.setItem(DRAFT_KEY, JSON.stringify({ name, key, description, selected }));
    setDraftSaved(true);
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(280px,340px)_1fr]">
            ...
            <aside className="lg:sticky lg:top-6 lg:self-start">
              <div className="rounded-xl border border-stone-200 bg-white">
                ...
                <div className="space-y-4 p-4">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="rkey" className="text-xs font-medium text-stone-600">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="rdesc" className="text-xs font-medium text-stone-600">
                      Description
                    </Label>
                    <textarea
                      id="rdesc"
            ...
            <section className="min-w-0">
              <div className="rounded-xl border border-stone-200 bg-white overflow-hidden">
                ...
                {catalogQ.isLoading && <div className="p-6"><Spinner label="Loading catalog…" /></div>}
                {catalogQ.isError && <div className="p-4"><ErrorNote>{apiErrorMessage(catalogQ.error)}</ErrorNote></div>}
