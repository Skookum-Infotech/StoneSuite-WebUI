...
export const CRM_CORE_SECTIONS: CrmCoreSection[] = [
  {
    ...
    fields: [
      ...
      { key: 'customer_name', label: 'Customer Name', type: 'text', required: true, placeholder: 'e.g. Acme Corp' },
      { key: 'customer_dba_name', label: 'Customer DBA Name', type: 'text', placeholder: 'e.g. Acme Trading Co.' },
      { key: 'customer_tax_id', label: 'EIN / TAN / GSTIN ID', type: 'text', placeholder: 'e.g. 12-3456789' },
      { key: 'customer_type', label: 'Customer Type', type: 'lookup-select', lookupKey: 'customerTypes' },
      { key: 'customer_authorized_person_fname', label: 'Authorized Person First Name', type: 'text', placeholder: 'e.g. Jane' },
      { key: 'customer_authorized_person_lname', label: 'Authorized Person Last Name', type: 'text', placeholder: 'e.g. Smith' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'customer_bill_addr_line1', label: 'Address Line 1', type: 'address', required: true, placeholder: 'e.g. 456 Commerce Blvd', showIfFieldFalse: 'customer_is_bill_as_primary' },
      ...
      { key: 'customer_bill_addr_city', label: 'City', type: 'text', required: true, placeholder: 'e.g. Chicago', showIfFieldFalse: 'customer_is_bill_as_primary' },
      { key: 'customer_bill_addr_country', label: 'Country', type: 'lookup-select', required: true, lookupKey: 'countries', showIfFieldFalse: 'customer_is_bill_as_primary' },
      { key: 'customer_bill_addr_state', label: 'State / Province', type: 'lookup-select', required: true, lookupKey: 'states', dependsOn: 'customer_bill_addr_country', showIfFieldFalse: 'customer_is_bill_as_primary' },
      { key: 'customer_bill_addr_zip', label: 'Zip / Postal Code', type: 'text', required: true, placeholder: 'e.g. 60601', showIfFieldFalse: 'customer_is_bill_as_primary' },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'customer_internal_notes', label: 'Internal Notes', type: 'textarea', placeholder: 'Add any internal notes or context about this record…' },
    ],
  },
  {
    title: 'Sales Fields',
    fields: [
      ...
      { key: 'customer_tax_exempt_reason', label: 'Tax Exempt Reason', type: 'textarea', placeholder: 'Describe the reason for the tax-exempt status…', showIfFieldTrue: 'customer_is_tax_exempt' },
