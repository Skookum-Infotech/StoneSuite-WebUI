...
export const quoteService = {
  ...
  // An approver's veto: rejects the quote while it awaits approval (a reason
  ...
  reject: (uuid: string, reason: string): Promise<Quote> =>
    tenantClient
      .post<{ success: boolean; quote: Quote }>(`${BASE}/${uuid}/reject`, { reason })
      .then((r) => r.data.quote),
